...
export const certifications = [
  // — HP LIFE —
  { period: "Sep 2025", title: "Agile Project Management", issuer: "HP LIFE", url: "public/certificates/hp-life/Agile Project Management.pdf" },
  { period: "Sep 2025", title: "AI for Beginners", issuer: "HP LIFE", url: "public/certificates/hp-life/AI for Beginners.pdf" },
  { period: "Sep 2025", title: "Cybersecurity Awareness", issuer: "HP LIFE", url: "public/certificates/hp-life/Cybersecurity Awareness.pdf" },

  // — Microsoft / NMU / Cisco —
  { period: "Jun 2025", title: "Microsoft AI Fluency", issuer: "Microsoft", url: "public/certificates/microsoft/Microsoft AI Fluency.pdf" },
  ...
  // — AI Bootcamp —
  { period: "AI Bootcamp", title: "Generative AI: Prompt Engineering Basics", issuer: "AI Bootcamp", url: "public/certificates/ai-bootcamp/Generative AI - Prompt Engineering Basics.pdf" },
  { period: "AI Bootcamp", title: "AI For Everyone", issuer: "AI Bootcamp", url: "public/certificates/ai-bootcamp/AI For Everyone.pdf" },
  { period: "AI Bootcamp", title: "Introduction to Artificial Intelligence (AI)", issuer: "AI Bootcamp", url: "public/certificates/ai-bootcamp/Intro to AI.pdf" },
  { period: "AI Bootcamp", title: "Introduction to Generative AI", issuer: "AI Bootcamp", url: "public/certificates/ai-bootcamp/Intro to Gen AI.pdf" },
  { period: "AI Bootcamp", title: "AI Essentials", issuer: "AI Bootcamp", url: "public/certificates/ai-bootcamp/AI Essentials.pdf" },
  { period: "AI Bootcamp", title: "Generative AI with Large Language Models", issuer: "AI Bootcamp", url: "public/certificates/ai-bootcamp/Generative AI with LLMs.pdf" },
  { period: "AI Bootcamp", title: "AI Foundations: Prompt Engineering with ChatGPT", issuer: "AI Bootcamp", url: "public/certificates/ai-bootcamp/AI Foundations.pdf" },
  { period: "AI Bootcamp", title: "Python for Data Science, AI & Development", issuer: "AI Bootcamp", url: "public/certificates/ai-bootcamp/Python for Data Science, AI & Development.pdf" },
  { period: "AI Bootcamp", title: "Supervised Machine Learning: Regression and Classification", issuer: "AI Bootcamp", url: "public/certificates/ai-bootcamp/Supervised ML.pdf" },
  { period: "AI Bootcamp", title: "Advanced Learning Algorithms", issuer: "AI Bootcamp", url: "public/certificates/ai-bootcamp/Advanced Learning Algorithms.pdf" },
  { period: "AI Bootcamp", title: "Unsupervised Learning, Recommenders, Reinforcement Learning", issuer: "AI Bootcamp", url: "public/certificates/ai-bootcamp/Unsupervised Learning.pdf" },
  { period: "AI Bootcamp", title: "Trustworthy AI: Managing Bias, Ethics, and Accountability", issuer: "AI Bootcamp", url: "public/certificates/ai-bootcamp/Trustworthy AI.pdf" },
  { period: "AI Bootcamp", title: "Introduction to Responsible AI", issuer: "AI Bootcamp", url: "public/certificates/ai-bootcamp/Introduction to Responsible AI.pdf" },

  // — Professional Development —
  { period: "Prof. Development", title: "Write Professional Emails in English", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Write Professional Emails in English.pdf" },
  { period: "Prof. Development", title: "Verbal Communications and Presentation Skills", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Verbal Communications and Presentation Skills.pdf" },
  { period: "Prof. Development", title: "Active Listening: Enhancing Communication Skills", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Active Listening.pdf" },
  { period: "Prof. Development", title: "Developing Interpersonal Skills", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Developing Interpersonal Skills.pdf" },
  { period: "Prof. Development", title: "Work Smarter, Not Harder: Time Management for Personal & Professional Productivity", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Work Smarter, Not Harder.pdf" },
  { period: "Prof. Development", title: "Emotional Intelligence in the Workplace", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Emotional Intelligence in the Workplace.pdf" },
  { period: "Prof. Development", title: "Finding Your Professional Voice: Confidence & Impact", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Finding Your Professional Voice - Confidence and Impact.pdf" },
  { period: "Prof. Development", title: "Introduction to Personal Branding", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Introduction to Personal Branding.pdf" },
  { period: "Prof. Development", title: "Leading with Impact: Team Dynamics, Strategy and Ethics", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Leading with Impact.pdf" },
  { period: "Prof. Development", title: "Financial Planning for Young Adults", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Financial Planning for Young Adults.pdf" },
  { period: "Prof. Development", title: "Preparation for Job Interviews", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Preparation for Job Interviews.pdf" },
  { period: "Prof. Development", title: "Job Interview Preparation Mastery", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Job Interview Preparation Mastery.pdf" },
  { period: "Prof. Development", title: "Prepare and Practice for Interviews with AI", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Prepare and Practice for Interviews with AI.pdf" },
  { period: "Prof. Development", title: "Psychology of the Self", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Psychology of the Self.pdf" },
  { period: "Prof. Development", title: "Managing Conflicts with Cultural and Emotional Intelligence", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Managing Conflicts with Cultural and Emotional Intelligence.pdf" },
  { period: "Prof. Development", title: "Positive Psychology: Resilience Skills", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Positive Psychology - Resilience Skills.pdf" },
  { period: "Prof. Development", title: "Grit and Growth Mindset", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Grit and Growth Mindset.pdf" },
  { period: "Prof. Development", title: "Solving Problems with Creative and Critical Thinking", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Solving Problems with Creative and Critical Thinking.pdf" },
  { period: "Prof. Development", title: "Negotiation skills: Negotiate and resolve conflict", issuer: "Candidate PD", url: "public/certificates/candidate-pd/Negotiation skills - Negotiate and resolve conflict.pdf" },
];
